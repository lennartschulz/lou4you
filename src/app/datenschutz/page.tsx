...
export const metadata: Metadata = {
  title: "Datenschutz | LOU4YOU GmbH",
};
...
<p><b>1.2</b>&nbsp;Verantwortlicher f&uuml;r die Datenverarbeitung auf dieser Website im Sinne der Datenschutz-Grundverordnung (DSGVO) ist LOU4YOU GmbH, Kamper Str. 54, 47445 Moers, Deutschland, Tel.: 0172 3454517, E-Mail: info@lou4you.com. Der f&uuml;r die Verarbeitung von personenbezogenen Daten Verantwortliche ist diejenige nat&uuml;rliche oder juristische Person, die allein oder gemeinsam mit anderen &uuml;ber die Zwecke und Mittel der Verarbeitung von personenbezogenen Daten entscheidet.</p>
...
<p>F&uuml;r das Hosting unserer Website und die Darstellung der Seiteninhalte nutzen wir das System des folgenden Anbieters: Vercel Inc., 440 N Barranca Ave #4133, Covina, CA 91723, USA</p>
...
<p>Wir nutzen ein Content Delivery Network des folgenden Anbieters: Vercel Inc., 440 N Barranca Avenue #4133, Covina, CA 91723, USA</p>
...
<p>F&uuml;r die Bereitstellung einer Online-Terminbuchungsfunktion nutzen wir die Dienste des folgenden Anbieters: Cal.com, Inc., 2261 Market St #4382, San Francisco, CA 94114, USA</p>
...
<p><b>4.3</b>&nbsp;Im Rahmen der Kontaktaufnahme mit uns (z.B. per Kontaktformular oder E-Mail) werden personenbezogene Daten erhoben. Welche Daten im Falle der Nutzung eines Kontaktformulars erhoben werden, ist aus dem jeweiligen Kontaktformular ersichtlich. Diese Daten werden ausschlie&szlig;lich zum Zweck der Beantwortung Ihres Anliegens bzw. f&uuml;r die Kontaktaufnahme und die damit verbundene technische Administration gespeichert und verwendet.</p>

<p>Rechtsgrundlage f&uuml;r die Verarbeitung dieser Daten ist unser berechtigtes Interesse an der Beantwortung Ihres Anliegens gem&auml;&szlig; Art. 6 Abs. 1 lit. f DSGVO. Zielt Ihre Kontaktierung auf den Abschluss eines Vertrages ab, so ist zus&auml;tzliche Rechtsgrundlage f&uuml;r die Verarbeitung Art. 6 Abs. 1 lit. b DSGVO. Ihre Daten werden nach abschlie&szlig;ender Bearbeitung Ihrer Anfrage gel&ouml;scht. Dies ist der Fall, wenn sich aus den Umst&auml;nden entnehmen l&auml;sst, dass der betroffene Sachverhalt abschlie&szlig;end gekl&auml;rt ist und sofern keine gesetzlichen Aufbewahrungspflichten entgegenstehen.</p>

<p><b>4.4</b>&nbsp;- Resend</p>

<p>F&uuml;r den Versand transaktionaler Mails, also anlassbezogener Nachrichten, die durch eine spezifische Nutzerinteraktion (etwa: Vertragsschluss, Registrierung oder Passwort-Reset) ausgel&ouml;st werden, nutzen wir diesen Anbieter: Plus Five Five, Inc., 2261 Market Street, #5039, San Francisco, CA 94114, USA</p>

<p>Auf Basis unseres berechtigten Interesses an einer effektiven und nutzerfreundlichen E-Mail-Kommunikation geben wir Ihre bei Ausf&uuml;hrung einer solchen Nutzeraktion bereitgestellten Daten gem. Art. 6 Abs. 1 lit. f DSGVO an diesen Anbieter weiter, damit dieser den Mailversand in unserem Auftrag &uuml;bernimmt.</p>
...
<p>Diese Website nutzt einen Webanalysedienst des folgenden Anbieters: Vercel Inc., 440 N Barranca Avenue #4133, Covina, CA 91723, USA</p>

<p>Zum Schutz der Seitenbesucher verwendet der Anbieter eine pseudonymisierte Besucherkennung, um verschiedene Analysen der Seitennutzung innerhalb eines kurzen Zeitfensters von maximal 24 Stunden zu erm&ouml;glichen. Diese Besucherkennung ist ein zuf&auml;llig generierter, zeitlich begrenzter Hash-Wert, der auf Grundlage einer reduzierten Menge technischer Attribute erstellt wird. Dazu z&auml;hlen insbesondere der User-Agent (Informationen zu Browser und Betriebssystem) sowie die anonymisierte IP-Adresse, die ausschlie&szlig;lich f&uuml;r die Dauer der Analyse verarbeitet und anschlie&szlig;end verworfen wird.</p>

<p>Sofern im Einzelfall doch personenbezogene Daten verarbeitet werden, erfolgt die Verarbeitung auf Basis unseres berechtigten Interesses an der statistischen Auswertung des Nutzungsverhaltens zu Optimierungszwecken gem&auml;&szlig; Art. 6 Abs. 1 lit. f DSGVO. Sie k&ouml;nnen der Datenerhebung und -speicherung Ihrer Besucherdaten f&uuml;r die Zukunft in diesem Fall dauerhaft durch Mitteilung an uns widersprechen.</p>
...
export default function DatenschutzPage() {
  return <ProsePage heading="Datenschutz" html={html} />;
}
